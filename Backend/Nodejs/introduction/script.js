// How to create server like this
const http = require('http'); //  http is just an object 
const github = [
  {
    "login": "mojombo",
    "id": 1,
...
// ya pe server create hogaya
const server = http.createServer((request,response)=>{
  //response.end("Hellow shahbaz ali"); // server ke pass data bheja [server backend se frontend me data beja mai]
...
//  is server pe lissen kate hai
server.listen(2000,()=>{
    console.log("I am lisner at port 2000");
